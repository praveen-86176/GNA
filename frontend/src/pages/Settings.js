      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <motion.div variants={staggerItem} className="mb-8">
            ...
            <p className="mt-2 text-gray-100 dark:text-gray-200">
                    ...
                    {tabs.map((tab) => (
                      <button
                        ...
                        className={cn(
                          ...
                          activeTab === tab.id
                            ? "bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border-r-2 border-purple-500 dark:border-purple-400"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                              <UserCircleIcon className="h-5 w-5 text-gray-400 dark:text-gray-300" />
                            </div>
                            <input
                              type="text"
                              value={profileForm.name}
                              onChange={(e) => setProfileForm(prev => ({ ...prev, name: e.target.value }))}
                              className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-gray-100"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-300"
                              disabled
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                              {isManager() ? (
                                <BuildingOfficeIcon className="h-5 w-5 text-gray-400 dark:text-gray-300" />
                              ) : (
                                <TruckIcon className="h-5 w-5 text-gray-400 dark:text-gray-300" />
                              )}
                            </div>
                            <input
                              type="text"
                            ...
                            <div className="md:col-span-1">
                              ...
                              <div className="relative">
                                ...
                                <textarea
                                  ...
                                  rows={3}
                                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-gray-100 resize-none"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                              ...
                              <select
                                ...
                                className="block w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                              >
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                !isDarkMode && !isSystemPreference ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                isSystemPreference ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                preferences.dashboard.compactView ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div>
                              <p className="font-medium text-gray-900 dark:text-gray-100">Show Metrics</p>
                              <p className="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                preferences.dashboard.showMetrics ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.newOrders ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.orderUpdates ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          {isManager && (
                            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                              ...
                              <button
                                ...
                                className={cn(
                                  "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                  notificationSettings.partnerUpdates ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                                )}
                              >
                                <span
                                  className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.orderAssignments ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.emailNotifications ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.smsNotifications ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.pushNotifications ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                notificationSettings.soundAlerts ? "bg-gradient-to-r from-rose-500 to-purple-500" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
              ...
              {activeTab === 'preferences' && (
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                      <div className="p-2 bg-white/10 backdrop-blur-sm rounded-lg">
                        <CogIcon className="h-6 w-6 text-gray-900" />
                      </div>
                  ...
                  <CardContent>
                    <form onSubmit={handlePreferencesSubmit} className="space-y-6">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Dashboard</h3>
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div>
                            ...
                            <button
                              ...
                              className={cn(
                                "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                preferences.dashboard.autoRefresh ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                              )}
                            >
                              <span
                                className={cn(
                          ...
                          {preferences.dashboard.autoRefresh && (
                            <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                              ...
                              <select
                                ...
                                className="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-gray-100"
                              >
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div>
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Show Metrics</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">Display performance metrics on dashboard</p>
                            </div>
                            <button
                              type="button"
                              onClick={() => updateDashboardPreference('showMetrics', !preferences.dashboard.showMetrics)}
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div>
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Compact View</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">Use compact layout for more information</p>
                            </div>
                            <button
                              type="button"
                              onClick={() => updateDashboardPreference('compactView', !preferences.dashboard.compactView)}
                      ...
                      {isManager() && (
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Order Management</h3>
                          <div className="space-y-4">
                            <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            ...
                            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                              <div>
                                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Auto-assign Partners</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Automatically assign available partners to orders</p>
                              </div>
                              <button
                                type="button"
                                ...
                                className={cn(
                                  "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                  preferences.orders.autoAssignPartners ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                                )}
                              >
                                <span
                                  className={cn(
                            ...
                            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                              <div>
                                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Require Confirmation</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Require confirmation before creating orders</p>
                              </div>
                              <button
                                type="button"
                                ...
                                className={cn(
                                  "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                  preferences.orders.requireConfirmation ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                                )}
                              >
                                <span
                                  className={cn(
                            ...
                            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                              <div>
                                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Priority Orders</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Enable priority ordering system</p>
                              </div>
                              <button
                                type="button"
                                ...
                                className={cn(
                                  "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                  preferences.orders.priorityOrders ? "bg-gradient-to-r from-purple-500 to-purple-600" : "bg-gray-200 dark:bg-gray-700"
                                )}
                              >
                                <span
                                  className={cn(
